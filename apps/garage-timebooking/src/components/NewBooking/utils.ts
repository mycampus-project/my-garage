import { isBefore, isEqual, isSameDay, isSameMinute, isWithinInterval } from 'date-fns';
...
export const isValidRange = (range: Range, existingBookings: Array<Interval>) => {
  if (!isSameDay(...range)) return false;
